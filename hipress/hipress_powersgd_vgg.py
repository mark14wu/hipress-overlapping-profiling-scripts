...
if args.algorithm == 'tbq':
    ...
    algorithm_params = {"matrix_approximation_rank": args.powersgd_rank}
elif args.algorithm == 'no_comp':
    algorithm_params = {}
else:
    raise ValueError
...
def trace_handler(prof):
    prof.export_chrome_trace("hipress_pytorch_vgg19_powerSGD.json")
...
def train(epoch):
    ...
    if args.profile:
        ...
        with profiler.profile(
            ...
            record_shapes=True,
            schedule=profiler.schedule(skip_first=100, wait=0, warmup=20, active=20, repeat=1),
